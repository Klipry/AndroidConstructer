...
class adapter_seil_color(private val context: Context, private val logoValue: String) : AsyncTask<Void, Void, Boolean>() {
    ...
    override fun doInBackground(vararg params: Void?): Boolean {
        ...
        try {
            ...
            writer.write("arb=adapter_seil_color") // Здесь мы отправляем параметр column_name со значением "
            writer.flush()
            ...
            val logoLocation = try {
                jsonResponse.getString("adapter_seil_color")
            } catch (e: JSONException) {
            ...
            val values = ContentValues().apply {
                put("adapter_seil_color", logoLocation)
            }
