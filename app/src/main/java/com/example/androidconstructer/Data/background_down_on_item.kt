...
class background_down_on_item(private val context: Context, private val logoValue: String) : AsyncTask<Void, Void, Boolean>() {
    ...
    override fun doInBackground(vararg params: Void?): Boolean {
        ...
        try {
            ...
            writer.write("arb=background_down_on_ite") // Здесь мы отправляем параметр column_name со значением "
            writer.flush()
            ...
            val logoLocation = try {
                jsonResponse.getString("background_down_on_ite")
            } catch (e: JSONException) {
            ...
            val values = ContentValues().apply {
                put("background_down_on_ite", logoLocation)
            }
