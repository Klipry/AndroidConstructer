...
class BattonCategory2(private val context: Context, private val logoValue: String) : AsyncTask<Void, Void, Boolean>() {
    ...
    override fun doInBackground(vararg params: Void?): Boolean {
        ...
        try {
            ...
            writer.write("arb=TwoCategory") // Здесь мы отправляем параметр column_name со значением "
            writer.flush()
            ...
            val logoLocation = try {
                jsonResponse.getString("TwoCategory")
            } catch (e: JSONException) {
            ...
            val values = ContentValues().apply {
                put(DBHelper.TwoCategory, logoLocation)
            }
