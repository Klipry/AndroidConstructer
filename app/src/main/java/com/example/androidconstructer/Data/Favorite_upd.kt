...
class Favorite_upd(private val context: Context, private val logoValue: String) : AsyncTask<Void, Void, Boolean>() {
    ...
    override fun doInBackground(vararg params: Void?): Boolean {
        ...
        try {
            ...
            writer.write("arb=adapter_backFullScreen") // Здесь мы отправляем параметр column_name со значением "
            writer.flush()
            ...
            val logoLocation = try {
                jsonResponse.getString("adapter_backFullScreen")
            } catch (e: JSONException) {
            ...
            val values = ContentValues().apply {
                put("adapter_backFullScreen", logoLocation)
            }
