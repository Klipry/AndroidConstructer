...
class BattonCategory5(private val context: Context, private val logoValue: String) : AsyncTask<Void, Void, Boolean>() {
    private var listener: (() -> Unit)? = null
    private val TAG = "UpdateCategory5"
    ...
    override fun doInBackground(vararg params: Void?): Boolean {
        ...
        try {
            ...
            writer.write("arb=FiveCategory") // Здесь мы отправляем параметр column_name со значением "
            writer.flush()
            ...
            val logoLocation = try {
                jsonResponse.getString("FiveCategory")
            } catch (e: JSONException) {
