...
class text_info_color_on_item(private val context: Context, private val logoValue: String) : AsyncTask<Void, Void, Boolean>() {
    ...
    override fun doInBackground(vararg params: Void?): Boolean {
        ...
        try {
            ...
            writer.write("arb=text_info_color_on_item") // Здесь мы отправляем параметр column_name со значением "
            writer.flush()
            ...
            val logoLocation = try {
                jsonResponse.getString("text_info_color_on_item")
            } catch (e: JSONException) {
            ...
            val values = ContentValues().apply {
                put("text_info_color_on_item", logoLocation)
            }
