...
class BattonCategory(private val context: Context, private val logoValue: String) : AsyncTask<Void, Void, Boolean>() {
    ...
    override fun doInBackground(vararg params: Void?): Boolean {
        ...
        try {
            ...
            writer.write("arb=OneCategory") // Здесь мы отправляем параметр column_name со значением "
            writer.flush()
            ...
            val logoLocation = try {
                jsonResponse.getString("OneCategory")
            } catch (e: JSONException) {
            ...
            val values = ContentValues().apply {
                put(DBHelper.OneCategory, logoLocation)
            }
